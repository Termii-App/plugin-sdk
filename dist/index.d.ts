...
export type PluginForwardInfo = ForwardInfo & {
    hostId: string;
};
/**
...
export interface PluginContext {
    ...
    hosts: {
        ...
        exec(hostId: string, command: string, opts?: {
            timeoutSecs?: number;
        }): Promise<{
            stdout: string;
            stderr: string;
    ...
    sftp: {
        /** 上传本地文件到远端主机。 */
        upload(hostId: string, localPath: string, remotePath: string, onProgress?: (p: {
            transferred: number;
            total: number;
        }) => void): Promise<void>;
        /** 从远端主机下载文件到本地路径。 */
        download(hostId: string, remotePath: string, localPath: string, onProgress?: (p: {
            transferred: number;
            total: number;
        }) => void): Promise<void>;
    };
